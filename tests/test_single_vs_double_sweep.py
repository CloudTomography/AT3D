"""Tests verifying the double-sweep gradient path matches the single-sweep path.
...
# ---------------------------------------------------------------------------
def _compare_single_vs_double_sweep(solvers, Sensordict, rte_grid,
                                 wavelength, unknown_variable,
                                 cost_function, exact_single_scatter,
                                 rtol=1e-4, atol=1e-10, label=""):
    """Run single-sweep and double-sweep paths, compare cost and gradient."""
    ...
    print(f"\n  [{label}]")
    print(f"  loss: single={loss_jac:.4e}  double={loss_adj:.4e}  reldiff={cost_rd:.2e}")
...
# ===========================================================================
class TestDoubleSweepSolarAlbedo:
...
# ===========================================================================
class TestDoubleSweepSolarAsymmetry:
