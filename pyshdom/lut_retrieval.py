"""
A quick code for 1D mono-angle retrievals.
...
class LUTRetrieval:
    ...
    def __init__(self, view_zenith, view_azimuth, sources, optical_property_generator,
        ...
        if solver_config is None:
            ...
            #This should be large due to lack of bas vertical resolution.
    ...
    def retrieve(self, observed_data, initial_vector, **fixed_variables):
        """
