...
def make_optical_properties(grid, extinction, ssalb, phase_function_indices,
    ...
    ----------
    grid : xr.Dataset
        A valid grid object with x, y, z coordinates. See pyshdom.grid for details.
    ...
    pyshdom.checks.check_optical_properties(optical_properties)
...
class UnknownScatterer:
    ...
    variable_transforms : Tuple
        ...
        a Cooordinate Transform and a StateToGrid transform. See pyshdom.transformsfor
        details.
    ...
    def add_variable(self, variable_name, coordinate_transform=None,
        ...
        coordinate_transform : pyshdom.transforms.CoordinateTransform
    ...
    def calculate_optical_properties(self, state, state_representation):
        ...
        state_representation : pyshdom.medium.StateRepresentation
...
class StateGenerator:
    ...
    and projects gradients calculated by pyshdom.gradient.LevisApproxGradient onto
    ...
    `unknown_scatterers` : pyshdom.containers.UnknownScatterers
        Contains the pyshdom.Medium.UnkonwnScatterer objects for all unknowns.
    `surfaces` : Dict
