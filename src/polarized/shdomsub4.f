...
C          CALL GET_INTERP_KERNEL(BCELL,GRIDPTR,GRIDPOS,XE,YE,ZE,FB)
...
C            DO KK=1,8
C              DO N=1,8
C                IF (EXTINCT(GRIDPTR(N,ICELL),IPA) .NE. 0.0) THEN
C                GRAD1(:,KK,IDR) = GRAD1(:,KK,IDR) + FC(N)*
C     .            GRAD8(:,KK,N,IDR)
C                ENDIF
C              ENDDO
C            ENDDO
...
C                DO N=1,8
C                IF (EXTINCT(GRIDPTR(N,ICELL),IPA) .NE. 0.0) THEN
C                  GRAD0(:,KK,IDR) = GRAD0(:,KK,IDR) + FC(N)*
C     .            GRAD8(:,KK,N,IDR)
C                ENDIF
C                ENDDO
C              ENDDO
